...
Box cubes[] =   {Box(glm::vec4 (0.0f, 3.0f, -6.0f, 1.0f), glm::vec4 (0.0f, 1.0f, 0.0f, 0.0f), 0.1, 1.0, 1.0, 1),
                 ...
                 Box(glm::vec4 (0.0f,8.4f,-28.0f,1.0f), glm::vec4 (0.0f, 1.0f, 0.0f, 0.0f), 0.5, 0.25, 0.25, 2),
...
Box cow =      Box(glm::vec4 (0.0f,9.5f,-28.0f,1.0f), glm::vec4 (0.0f, 1.0f, 0.0f, 0.0f), 0.35, 0.35, 0.35, 2);
